...
(defvar nmodl-font-lock-keywords
      '(
        ...
        ("\\<\\(FROM\\|TO\\|COMPARTMENT\\|SOLVE\||STEADYSTATE\\|METHOD\\|SUFFIX\\|USEION\\|READ\\|WRITE\\|GLOBAL\\|RANGE\\|POINTER\\|LONGITUDINAL_DIFFUSION\\|LINEAR\\|NONLINEAR\\|SOLVE\\|POINT_PROCESS\\|NONSPECIFIC_CURRENT\\|STEADYSTATE\\|CONSERVE\\)\\>" . font-lock-keyword-face))
